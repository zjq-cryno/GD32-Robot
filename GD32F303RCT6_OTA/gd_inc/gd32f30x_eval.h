...
#define USER_KEY1_EXTI_PORT_SOURCE       GPIO_EVENT_PORT_GPIOC
#define USER_KEY1_EXTI_PIN_SOURCE        GPIO_EVENT_PIN_5
...
#define USER_KEY2_EXTI_PORT_SOURCE       GPIO_EVENT_PORT_GPIOC
#define USER_KEY2_EXTI_PIN_SOURCE        GPIO_EVENT_PIN_4
