...
// 测试数据长度
#define FLASH_DATA_LEN 256
#define FLASH_ADDR 0x00010000
...
#define EMERGENCY_CHECK_INTERVAL 500 // 状态检测间隔(ms)
#define OVER_TEMP_THRESHOLD 600      // 温度保护阈值(60.0°C = 600*0.1°C)
...
typedef enum {
    OTA_IDLE = 0,           // 空闲
    OTA_PENDING = 1,            // 收到OTA请求，等待队列清空
    OTA_UPGRADING = 2           // 开始OTA升级
} ota_status_t;
...
#define SPI1_CS_1   HAL_GPIO_WritePin(SPI1_CS_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_SET)     // CS 引脚置1				PA4
#define SPI1_RST_0  HAL_GPIO_WritePin(SPI1_RST_GPIO_Port, SPI1_RST_Pin, GPIO_PIN_RESET) // RST 引脚置0				PA8
#define SPI1_RST_1  HAL_GPIO_WritePin(SPI1_RST_GPIO_Port, SPI1_RST_Pin, GPIO_PIN_SET)   // RST 引脚置1
#define SPI1_DC_0   HAL_GPIO_WritePin(SPI1_DC_GPIO_Port, SPI1_DC_Pin, GPIO_PIN_RESET)   // DC 引脚置0     PC13
#define SPI1_DC_1   HAL_GPIO_WritePin(SPI1_DC_GPIO_Port, SPI1_DC_Pin, GPIO_PIN_SET)     // DC 引脚置1
#define SPI1_MOSI_0	HAL_GPIO_WritePin(SPI1_MOSI_GPIO_Port, SPI1_MOSI_Pin, GPIO_PIN_RESET)   // MOSI 引脚置0  PA7
#define SPI1_MOSI_1	HAL_GPIO_WritePin(SPI1_MOSI_GPIO_Port, SPI1_MOSI_Pin, GPIO_PIN_SET)   // MOSI 引脚置1
#define SPI1_SCK_0	HAL_GPIO_WritePin(SPI1_SCK_GPIO_Port, SPI1_SCK_Pin, GPIO_PIN_RESET)   // SCK 引脚置0   PA5
#define SPI1_SCK_1	HAL_GPIO_WritePin(SPI1_SCK_GPIO_Port, SPI1_SCK_Pin, GPIO_PIN_SET)   // SCK 引脚置1
