                                       ...
                                       const uint8_t aData[], uint32_t *pTxMailbox)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
        ...
        ((tsr & CAN_TSR_TME2) != 0U))
    {
      ...
      if(CAN_TSR_TME0 == (tsr &CAN_TSR_TME0)){transmitmailbox = 0;}
			else if(CAN_TSR_TME1 == (tsr &CAN_TSR_TME1)){transmitmailbox = 1;}
			else if(CAN_TSR_TME2 == (tsr &CAN_TSR_TME2)){transmitmailbox = 2;}
			else{transmitmailbox = 3;}
